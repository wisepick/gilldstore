                ...
                <asp:Repeater ID="Shipping_Repeater" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="View_Button" runat="server" Text="See Detail" OnClick="View_Button_Click" />
                                <asp:HyperLink ID="hyperlink1" runat="server" NavigateUrl='<%# "http://www.tpcindia.com/Tracking2014.aspx?id=" + Eval("SHIPPING_REFERENCE").ToString() + "&type=0&service=0" %>' Text='<%# Eval("SHIPPING_REFERENCE") %>' Visible='<%# !GilldStore_New.App_Start.CommonClass.Display_Attributes_IfMathes(Eval("SHIPPING_REFERENCE").ToString(), "") && Eval("AGENCY_NAME").ToString().Contains("Professional")%>' Target="_blank" >

                                </asp:HyperLink>
                                <asp:HyperLink ID="hyperlink2" runat="server" NavigateUrl='<%# "http://180.151.69.100/cgi_bin/show_status1.php?awb=" + Eval("SHIPPING_REFERENCE").ToString() + "&type=0&service=0" %>' Text='<%# Eval("SHIPPING_REFERENCE") %>' Visible='<%# !GilldStore_New.App_Start.CommonClass.Display_Attributes_IfMathes(Eval("SHIPPING_REFERENCE").ToString(), "") && Eval("AGENCY_NAME").ToString().Contains("ST")%>' Target="_blank" >

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnDeliveredForm.ascx.cs" Inherits="GilldStore_New.Controls.Order.UnDeliveredForm" %>
    ...
    <td colspan="4">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <strong>Undelivered Details</strong>
            </div>
            <div class="panel-body">
                <table style="width:100%" class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="UnDelivered_Reason_Id" runat="server" AppendDataBoundItems="true" DataTextField="ATTRIBUTE_NAME" DataValueField="ATTRIBUTE_ID" CssClass="form-control">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="UnDelivered_Reason" runat="server" MaxLength="255">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
